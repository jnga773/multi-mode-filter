...
!    gfortran -O3 ./MODULE_single_filter.f90 ./g1_RK4.f90 -o [NAME]
...
PROGRAM PARAMETRIC_OSCILLATOR_FILTERED_AUTO_CORRELATION
...
END PROGRAM PARAMETRIC_OSCILLATOR_FILTERED_AUTO_CORRELATION
...
ALLOCATE(corr_matrix(0:tau_steps, 2))
corr_matrix = 0.0d0
...
! Set filenames
! Parameters
filename_parameters = "./data_files/g2_parameters.txt"
! Data
filename_g2 = "./data_files/g2_corr.txt"
...
DO index = 0, tau_steps
  ...
  WRITE(2, *) DBLE(index) * dt, corr_matrix(index, :)
END DO

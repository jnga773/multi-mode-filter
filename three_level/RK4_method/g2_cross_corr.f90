...
DO l = -N, N
  DO k = -N, N
    DO j = -N, N
      ...
      !---------------------------------!
      cav3_ss(j, k, l, atab) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, a, eg, 1, 2) + &
                             & -CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, a, fe, 1, 2) + &
                             & -gkl(k, a) * cavsig3_ss(j, l, ata, ge, 1, 2) + &
                             & -gkl(k, a) * xi * cavsig3_ss(j, l, ata, ef, 1, 2) + &
                             & -gkl(l, b) * cavsig3_ss(j, k, ata, ge, 1, 1) + &
                             & -gkl(l, b) * xi * cavsig3_ss(j, k, ata, ef, 1, 1)
      ...
      !---------------------------------!
      cav3_ss(j, k, l, btba) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, a, eg, 2, 1) + &
                             & -CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, a, fe, 2, 1) + &
                             & -gkl(k, b) * cavsig3_ss(j, l, ata, ge, 2, 1) + &
                             & -gkl(k, b) * xi * cavsig3_ss(j, l, ata, ef, 2, 1) + &
                             & -gkl(l, a) * cavsig3_ss(j, k, ata, ge, 2, 2) + &
                             & -gkl(l, a) * xi * cavsig3_ss(j, k, ata, ef, 2, 2)
      ...
      !-------------------------------------------!
      cav3_ss(j, k, l, btata) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, ata, eg, 1, 1) + &
                              & -CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, ata, fe, 1, 1) + &
                              & -CONJG(gkl(k, a)) * cavsig3_ss(j, l, ata, eg, 2, 1) + &
                              & -CONJG(gkl(k, a)) * xi * cavsig3_ss(j, l, ata, fe, 2, 1) + &
                              & -gkl(l, a) * cavsig3_ss(j, k, at, ge, 2, 1) + &
                              & -gkl(l, a) * xi * cavsig3_ss(j, k, at, ef, 2, 1)
      ...
      !-------------------------------------------!
      cav3_ss(j, k, l, atbtb) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, ata, eg, 2, 2) + &
                              & -CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, ata, fe, 2, 2) + &
                              & -CONJG(gkl(k, b)) * cavsig3_ss(j, l, ata, eg, 1, 2) + &
                              & -CONJG(gkl(k, b)) * xi * cavsig3_ss(j, l, ata, fe, 1, 2) + &
                              & -gkl(l, b) * cavsig3_ss(j, k, at, ge, 1, 2) + &
                              & -gkl(l, b) * xi * cavsig3_ss(j, k, at, ef, 1, 2)
      ...
      ! Set the non-homogeneous vector
      B_vec = 0.0d0
      B_vec(1) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, a, eg, 1, 2) + &
               & -gkl(k, a) * cavsig3_ss(j, l, ata, ge, 1, 2) + &
               & -gkl(l, b) * cavsig3_ss(j, k, ata, ge, 1, 1)
      B_vec(2) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, a, ee, 1, 2) + &
               & -gkl(k, a) * xi * cavsig3_ss(j, l, ata, gf, 1, 2) + &
               & -gkl(l, b) * xi * cavsig3_ss(j, k, ata, gf, 1, 1)
      B_vec(3) = -CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, a, fg, 1, 2) + &
               & -gkl(k, a) * cavsig3_ss(j, l, ata, ee, 1, 2) + &
               & -gkl(l, b) * cavsig3_ss(j, k, ata, ee, 1, 1)
      B_vec(4) = Gamma * (xi ** 2) * cav3_ss(j, k, l, atab) + &
               & -CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, a, fe, 1, 2) + &
               & -gkl(k, a) * xi * cavsig3_ss(j, l, ata, ef, 1, 2) + &
               & -gkl(l, b) * xi * cavsig3_ss(j, k, ata, ef, 1, 1)
      B_vec(5) = i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, atab) + &
               & CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, a, gg, 1, 2) + &
               & CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, a, ee, 1, 2) + &
               & -CONJG(gkl(j, a)) * xi * cav2_ss(k, l, a, 1, 2)
      B_vec(6) = -i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, atab) + &
               & gkl(k, a) * xi * cavsig3_ss(j, l, ata, gg, 1, 2) + &
               & gkl(k, a) * xi * cavsig3_ss(j, l, ata, ee, 1, 2) + &
               & -gkl(k, a) * xi * cav2_ss(j, l, ata, 1, 2) + &
               & gkl(l, b) * xi * cavsig3_ss(j, k, ata, gg, 1, 1) + &
               & gkl(l, b) * xi * cavsig3_ss(j, k, ata, ee, 1, 1) + &
               & -gkl(l, b) * xi * cav2_ss(j, k, ata, 1, 1)
      B_vec(7) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, a, ef, 1, 2)
      B_vec(8) = -gkl(k, a) * cavsig3_ss(j, l, ata, fe, 1, 2) + &
               & -gkl(l, b) * cavsig3_ss(j, k, ata, fe, 1, 1)
      ...
      ! Set the non-homogeneous vector
      B_vec = 0.0d0
      B_vec(1) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, a, eg, 2, 1) + &
               & -gkl(k, b) * cavsig3_ss(j, l, ata, ge, 2, 1) + &
               & -gkl(l, a) * cavsig3_ss(j, k, ata, ge, 2, 2)
      B_vec(2) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, a, ee, 2, 1) + &
               & -gkl(k, b) * xi * cavsig3_ss(j, l, ata, gf, 2, 1) + &
               & -gkl(l, a) * xi * cavsig3_ss(j, k, ata, gf, 2, 2)
      B_vec(3) = -CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, a, fg, 2, 1) + &
               & -gkl(k, b) * cavsig3_ss(j, l, ata, ee, 2, 1) + &
               & -gkl(l, a) * cavsig3_ss(j, k, ata, ee, 2, 2)
      B_vec(4) = Gamma * (xi ** 2) * cav3_ss(j, k, l, btba) + &
               & -CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, a, fe, 2, 1) + &
               & -gkl(k, b) * xi * cavsig3_ss(j, l, ata, ef, 2, 1) + &
               & -gkl(l, a) * xi * cavsig3_ss(j, k, ata, ef, 2, 2)
      B_vec(5) = i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, btba) + &
               & CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, a, gg, 2, 1) + &
               & CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, a, ee, 2, 1) + &
               & -CONJG(gkl(j, b)) * xi * cav2_ss(k, l, a, 2, 1)
      B_vec(6) = -i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, btba) + &
               & gkl(k, b) * xi * cavsig3_ss(j, l, ata, gg, 2, 1) + &
               & gkl(k, b) * xi * cavsig3_ss(j, l, ata, ee, 2, 1) + &
               & -gkl(k, b) * xi * cav2_ss(j, l, ata, 2, 1) + &
               & gkl(l, a) * xi * cavsig3_ss(j, k, ata, gg, 2, 2) + &
               & gkl(l, a) * xi * cavsig3_ss(j, k, ata, ee, 2, 2) + &
               & -gkl(l, a) * xi * cav2_ss(j, k, ata, 2, 2)
      B_vec(7) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, a, ef, 2, 1)
      B_vec(8) = -gkl(k, b) * cavsig3_ss(j, l, ata, fe, 2, 1) + &
               & -gkl(l, a) * cavsig3_ss(j, k, ata, fe, 2, 2)
      ...
      ! Set the non-homogeneous vector
      B_vec = 0.0d0
      B_vec(1) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, ata, eg, 1, 1) + &
               & -CONJG(gkl(k, a)) * cavsig3_ss(j, l, ata, eg, 2, 1) + &
               & -gkl(l, a) * cavsig3_ss(j, k, at, ge, 2, 1)
      B_vec(2) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, ata, ee, 1, 1) + &
               & -CONJG(gkl(k, a)) * cavsig3_ss(j, l, ata, ee, 2, 1) + &
               & -gkl(l, a) * xi * cavsig3_ss(j, k, at, gf, 2, 1)
      B_vec(3) = -CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, ata, fg, 1, 1) + &
               & -CONJG(gkl(k, a)) * xi * cavsig3_ss(j, l, ata, fg, 2, 1) + &
               & -gkl(l, a) * cavsig3_ss(j, k, at, ee, 2, 1)
      B_vec(4) = Gamma * (xi ** 2) * cav3_ss(j, k, l, btata) + &
               & -CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, ata, fe, 1, 1) + &
               & -CONJG(gkl(k, a)) * xi * cavsig3_ss(j, l, ata, fe, 2, 1) + &
               & -gkl(l, a) * xi * cavsig3_ss(j, k, at, ef, 2, 1)
      B_vec(5) = i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, btata) + &
               & CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, ata, gg, 1, 1) + &
               & CONJG(gkl(j, b)) * xi * cavsig3_ss(k, l, ata, ee, 1, 1) + &
               & -CONJG(gkl(j, b)) * xi * cav2_ss(k, l, ata, 1, 1) + &
               & CONJG(gkl(k, a)) * xi * cavsig3_ss(j, l, ata, gg, 2, 1) + &
               & CONJG(gkl(k, a)) * xi * cavsig3_ss(j, l, ata, ee, 2, 1) + &
               & -CONJG(gkl(k, a)) * xi * cav2_ss(j, l, ata, 2, 1)
      B_vec(6) = -i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, btata) + &
               & gkl(l, a) * xi * cavsig3_ss(j, k, at, gg, 2, 1) + &
               & gkl(l, a) * xi * cavsig3_ss(j, k, at, ee, 2, 1) + &
               & -gkl(l, a) * xi * cav2_ss(j, k, at, 2, 1)
      B_vec(7) = -CONJG(gkl(j, b)) * cavsig3_ss(k, l, ata, ef, 1, 1) + &
               & -CONJG(gkl(k, a)) * cavsig3_ss(j, l, ata, ef, 2, 1)
      B_vec(8) = -gkl(l, a) * cavsig3_ss(j, k, at, fe, 2, 1)
      ...
      ! Set the non-homogeneous vector
      B_vec = 0.0d0
      B_vec(1) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, ata, eg, 2, 2) + &
               & -CONJG(gkl(k, b)) * cavsig3_ss(j, l, ata, eg, 1, 2) + &
               & -gkl(l, b) * cavsig3_ss(j, k, at, ge, 1, 2)
      B_vec(2) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, ata, ee, 2, 2) + &
               & -CONJG(gkl(k, b)) * cavsig3_ss(j, l, ata, ee, 1, 2) + &
               & -gkl(l, b) * xi * cavsig3_ss(j, k, at, gf, 1, 2)
      B_vec(3) = -CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, ata, fg, 2, 2) + &
               & -CONJG(gkl(k, b)) * xi * cavsig3_ss(j, l, ata, fg, 1, 2) + &
               & -gkl(l, b) * cavsig3_ss(j, k, at, ee, 1, 2)
      B_vec(4) = Gamma * (xi ** 2) * cav3_ss(j, k, l, atbtb) + &
               & -CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, ata, fe, 2, 2) + &
               & -CONJG(gkl(k, b)) * xi * cavsig3_ss(j, l, ata, fe, 1, 2) + &
               & -gkl(l, b) * xi * cavsig3_ss(j, k, at, ef, 1, 2)
      B_vec(5) = i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, atbtb) + &
               & CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, ata, gg, 2, 2) + &
               & CONJG(gkl(j, a)) * xi * cavsig3_ss(k, l, ata, ee, 2, 2) + &
               & -CONJG(gkl(j, a)) * xi * cav2_ss(k, l, ata, 2, 2) + &
               & CONJG(gkl(k, b)) * xi * cavsig3_ss(j, l, ata, gg, 1, 2) + &
               & CONJG(gkl(k, b)) * xi * cavsig3_ss(j, l, ata, ee, 1, 2) + &
               & -CONJG(gkl(k, b)) * xi * cav2_ss(j, l, ata, 1, 2)
      B_vec(6) = -i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, atbtb) + &
               & gkl(l, b) * xi * cavsig3_ss(j, k, at, gg, 1, 2) + &
               & gkl(l, b) * xi * cavsig3_ss(j, k, at, ee, 1, 2) + &
               & -gkl(l, b) * xi * cav2_ss(j, k, at, 1, 2)
      B_vec(7) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, ata, ef, 2, 2) + &
               & -CONJG(gkl(k, b)) * cavsig3_ss(j, l, ata, ef, 1, 2)
      B_vec(8) = -gkl(l, b) * cavsig3_ss(j, k, at, fe, 1, 2)
...
DO m = -N, N
  DO j = -N, N
    ! First-order: Atom
    sigma(:) = sigma(:) + cavsig3_ss(j, m, ata, :, 1, 1)
    ...
    END DO
    ! Non homogeneous vector
    B_OG(4) = B_OG(4) + Gamma * (xi ** 2) * cav2_ss(j, m, ata, 1, 1)
    B_OG(5) = B_OG(5) + i * xi * 0.5d0 * Omega * cav2_ss(j, m, ata, 1, 1)
    B_OG(6) = B_OG(6) - i * xi * 0.5d0 * Omega * cav2_ss(j, m, ata, 1, 1)

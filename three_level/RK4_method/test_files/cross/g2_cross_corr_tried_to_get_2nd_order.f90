...
DO k = -N, N
  DO j = -N, N
    ...
    ! < a_{j} b_{k} > !
    !-----------------!
    cav2_ss(j, k, ab) = -gkl(j, a) * cavsig2_ss(k, a, ge, 2) + &
                      & -gkl(j, a) * xi * cavsig2_ss(k, a, ef, 2) + &
                      & -gkl(k, b) * cavsig2_ss(j, a, ge, 1) + &
                      & -gkl(k, b) * xi * cavsig2_ss(j, a, ef, 1)
    ...
    !-------------------------------------!
    cav2_ss(j, k, atbt) = -CONJG(gkl(j, a)) * cavsig2_ss(k, at, eg, 2) + &
                        & -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, at, fe, 2) + &
                        & -CONJG(gkl(k, b)) * cavsig2_ss(j, at, eg, 1) + &
                        & -CONJG(gkl(k, b)) * xi * cavsig2_ss(j, at, fe, 1)
    ...
    ! < a^{\dagger}_{j} a_{k} > !
    !---------------------------!
    cav2_ss(j, k, ata) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, eg, 1) + &
                       & -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, fe, 1) + &
                       & -gkl(k, a) * cavsig2_ss(j, at, ge, 1) + &
                       & -gkl(k, a) * xi * cavsig2_ss(j, at, ef, 1)
    ...
    ! < a^{\dagger}_{j} b_{k} > !
    !---------------------------!
    cav2_ss(j, k, atb) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, eg, 2) + &
                       & -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, fe, 2) + &
                       & -gkl(k, b) * cavsig2_ss(j, at, ge, 1) + &
                       & -gkl(k, b) * xi * cavsig2_ss(j, at, ef, 1)
    ...
    ! < b^{\dagger}_{j} a_{k} > !
    !---------------------------!
    cav2_ss(j, k, bta) = -CONJG(gkl(j, b)) * cavsig2_ss(k, a, eg, 1) + &
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -gkl(j, a) * cavsig2_ss(k, a, ge, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, a, ge, 1)
    B_vec(2) = -gkl(j, a) * xi * cavsig2_ss(k, a, gf, 2) + &
             & -gkl(k, b) * xi * cavsig2_ss(j, a, gf, 1)
    B_vec(3) = -gkl(j, a) * cavsig2_ss(k, a, ee, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, a, ee, 1)
    B_vec(4) = Gamma * (xi ** 2) * cav2_ss(j, k, ab) + &
             & -gkl(j, a) * xi * cavsig2_ss(k, a, ef, 2) + &
             & -gkl(k, b) * xi * cavsig2_ss(j, a, ef, 1)
    B_vec(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, ab)
    B_vec(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, ab) + &
             & gkl(j, a) * xi * cavsig2_ss(k, a, gg, 2) + &
             & gkl(j, a) * xi * cavsig2_ss(k, a, ee, 2) + &
             & -gkl(j, a) * xi * cav1_ss(k, a, 2) + &
             & gkl(k, b) * xi * cavsig2_ss(j, a, gg, 1) + &
             & gkl(k, b) * xi * cavsig2_ss(j, a, ee, 1) + &
             & -gkl(k, b) * xi * cav1_ss(j, a, 1)
    B_vec(7) = 0.0d0
    B_vec(8) = -gkl(j, a) * cavsig2_ss(k, a, fe, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, a, fe, 1)
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -CONJG(gkl(j, a)) * cavsig2_ss(k, at, eg, 2) + &
             & -CONJG(gkl(k, b)) * cavsig2_ss(j, at, eg, 1)
    B_vec(2) = -CONJG(gkl(j, a)) * cavsig2_ss(k, at, ee, 2) + &
             & -CONJG(gkl(k, b)) * cavsig2_ss(j, at, ee, 1)
    B_vec(3) = -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, at, fg, 2) + &
             & -CONJG(gkl(k, b)) * xi * cavsig2_ss(j, at, fg, 1)
    B_vec(4) = Gamma * (xi ** 2) * cav2_ss(j, k, atbt) + &
             & -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, at, fe, 2) + &
             & -CONJG(gkl(k, b)) * xi * cavsig2_ss(j, at, fe, 1)
    B_vec(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, atbt) + &
             & CONJG(gkl(j, a)) * xi * cavsig2_ss(k, at, gg, 2) + &
             & CONJG(gkl(j, a)) * xi * cavsig2_ss(k, at, ee, 1) + &
             & -CONJG(gkl(j, a)) * xi * cav1_ss(k, at, 2) + &
             & CONJG(gkl(k, b)) * xi * cavsig2_ss(j, at, gg, 1) + &
             & CONJG(gkl(k, b)) * xi * cavsig2_ss(j, at, ee, 1) + &
             & -CONJG(gkl(k, b)) * xi * cav1_ss(j, at, 1)
    B_vec(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, atbt)
    B_vec(7) = -CONJG(gkl(j, a)) * cavsig2_ss(k, at, ef, 2) + &
             & -CONJG(gkl(k, b)) * cavsig2_ss(j, at, ef, 1)
    B_vec(8) = 0.0d0
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, eg, 1) + &
             & -gkl(k, a) * cavsig2_ss(j, at, ge, 1)
    B_vec(2) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, ee, 1) + &
             & -gkl(k, a) * xi * cavsig2_ss(j, at, gf, 1)
    B_vec(3) = -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, fg, 1) + &
             & -gkl(k, a) * cavsig2_ss(j, at, ee, 1)
    B_vec(4) = Gamma * (xi ** 2) * cav2_ss(j, k, ata) + &
             & -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, fe, 1) + &
             & -gkl(k, a) * xi * cavsig2_ss(j, at, ef, 1)
    B_vec(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, ata) + &
             & CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, gg, 1) + &
             & CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, ee, 1) + &
             & -CONJG(gkl(j, a)) * xi * cav1_ss(k, a, 1)
    B_vec(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, ata) + &
             & gkl(k, a) * xi * cavsig2_ss(j, at, gg, 1) + &
             & gkl(k, a) * xi * cavsig2_ss(j, at, ee, 1) + &
             & -gkl(k, a) * xi * cav1_ss(j, at, 1)
    B_vec(7) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, ef, 1)
    B_vec(8) = -gkl(k, a) * cavsig2_ss(j, at, fe, 1)
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -CONJG(gkl(j, b)) * cavsig2_ss(k, a, eg, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, at, ge, 2)
    B_vec(2) = -CONJG(gkl(j, b)) * cavsig2_ss(k, a, ee, 2) + &
             & -gkl(k, b) * xi * cavsig2_ss(j, at, gf, 2)
    B_vec(3) = -CONJG(gkl(j, b)) * xi * cavsig2_ss(k, a, fg, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, at, ee, 2)
    B_vec(4) = Gamma * (xi ** 2) * cav2_ss(j, k, btb) + &
             & -CONJG(gkl(j, b)) * xi * cavsig2_ss(k, a, fe, 2) + &
             & -gkl(k, b) * xi * cavsig2_ss(j, at, ef, 2)
    B_vec(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, btb) + &
             & CONJG(gkl(j, b)) * xi * cavsig2_ss(k, a, gg, 2) + &
             & CONJG(gkl(j, b)) * xi * cavsig2_ss(k, a, ee, 2) + &
             & -CONJG(gkl(j, b)) * xi * cav1_ss(k, a, 2)
    B_vec(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, btb) + &
             & gkl(k, b) * xi * cavsig2_ss(j, at, gg, 2) + &
             & gkl(k, b) * xi * cavsig2_ss(j, at, ee, 2) + &
             & -gkl(k, b) * xi * cav1_ss(j, at, 2)
    B_vec(7) = -CONJG(gkl(j, b)) * cavsig2_ss(k, a, ef, 2)
    B_vec(8) = - gkl(k, b) * cavsig2_ss(j, at, fe, 2)
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, eg, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, at, ge, 1)
    B_vec(2) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, ee, 2) + &
             & -gkl(k, b) * xi * cavsig2_ss(j, at, gf, 1)
    B_vec(3) = -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, fg, 2) + &
             & -gkl(k, b) * cavsig2_ss(j, at, ee, 1)
    B_vec(4) = Gamma * (xi ** 2) * cav2_ss(j, k, atb) + &
             & -CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, fe, 2) + &
             & -gkl(k, b) * xi * cavsig2_ss(j, at, ef, 1)
    B_vec(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, atb) + &
             & CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, gg, 2) + &
             & CONJG(gkl(j, a)) * xi * cavsig2_ss(k, a, ee, 2) + &
             & -CONJG(gkl(j, a)) * xi * cav1_ss(k, a, 2)
    B_vec(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, atb) + &
             & gkl(k, b) * xi * cavsig2_ss(j, at, gg, 1) + &
             & gkl(k, b) * xi * cavsig2_ss(j, at, ee, 1) + &
             & -gkl(k, b) * xi * cav1_ss(j, at, 1)
    B_vec(7) = -CONJG(gkl(j, a)) * cavsig2_ss(k, a, ef, 2)
    B_vec(8) = - gkl(k, b) * cavsig2_ss(j, at, fe, 1)
  ...
  DO k = -N, N
    DO j = -N, N
      ...
      cav3_ss(j, k, l, atab) = -CONJG(gkl(j, a)) * cavsig3_ss(k, l, ab, eg) + &
                             ...
                             & -gkl(k, a) * xi * cavsig3_ss(j, l, ata, ef) + &

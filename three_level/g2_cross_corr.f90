...
DO cj = 1, 2
  ...
  DO j = -N, N
    ...
    B = 0.0d0
    B(1) = -gkl(j, cj) * sigma_ss(ge)
    B(2) = -gkl(j, cj) * xi * sigma_ss(gf)
    B(3) = -gkl(j, cj) * sigma_ss(ee)
    B(4) = Gamma * (xi ** 2) * cav1_ss(j, a, cj) + &
         & -gkl(j, cj) * xi * sigma_ss(ef)
    B(5) = i * xi * 0.5d0 * Omega * cav1_ss(j, a, cj)
    B(6) = -i * xi * 0.5d0 * Omega * cav1_ss(j, a, cj) + &
         & gkl(j, cj) * xi * sigma_ss(gg) + &
         & gkl(j, cj) * xi * sigma_ss(ee) + &
         & -gkl(j, cj) * xi
    B(7) = 0.0d0
    B(8) = -gkl(j, cj) * sigma_ss(fe)
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -CONJG(gkl(j, cj)) * sigma_ss(eg)
    B(2) = -CONJG(gkl(j, cj)) * sigma_ss(ee)
    B(3) = -CONJG(gkl(j, cj)) * xi * sigma_ss(fg)
    B(4) = Gamma * (xi ** 2) * cav1_ss(j, at, cj) + &
         & -CONJG(gkl(j, cj)) * xi * sigma_ss(fe)
    B(5) = i * xi * 0.5d0 * Omega * cav1_ss(j, at, cj) + &
         & CONJG(gkl(j, cj)) * xi * sigma_ss(gg) + &
         & CONJG(gkl(j, cj)) * xi * sigma_ss(ee) + &
         & -CONJG(gkl(j, cj)) * xi
    B(6) = -i * xi * 0.5d0 * Omega * cav1_ss(j, at, cj)
    B(7) = -CONJG(gkl(j, cj)) * sigma_ss(ef)
    B(8) = 0.0d0
  ...
  DO cj = 1, 2
    ...
    DO k = -N, N
      DO j = -N, N
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -gkl(j, cj) * cavsig2_ss(k, a, ge, ck) + &
             & -gkl(k, ck) * cavsig2_ss(j, a, ge, cj)
        B(2) = -gkl(j, cj) * xi * cavsig2_ss(k, a, gf, ck) + &
             & -gkl(k, ck) * xi * cavsig2_ss(j, a, gf, cj)
        B(3) = -gkl(j, cj) * cavsig2_ss(k, a, ee, ck) + &
             & -gkl(k, ck) * cavsig2_ss(j, a, ee, cj)
        B(4) = Gamma * (xi ** 2) * cav2_ss(j, k, a, cj, ck) + &
             & -gkl(j, cj) * xi * cavsig2_ss(k, a, ef, ck) + &
             & -gkl(k, ck) * xi * cavsig2_ss(j, a, ef, cj)
        B(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, a, cj, ck)
        B(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, a, cj, ck) + &
        ...
        B(7) = 0.0d0
        B(8) = -gkl(j, cj) * cavsig2_ss(k, a, fe, ck) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -CONJG(gkl(j, cj)) * cavsig2_ss(k, at, eg, ck) + &
             & -CONJG(gkl(k, ck)) * cavsig2_ss(j, at, eg, cj)
        B(2) = -CONJG(gkl(j, cj)) * cavsig2_ss(k, at, ee, ck) + &
             & -CONJG(gkl(k, ck)) * cavsig2_ss(j, at, ee, cj)
        B(3) = -CONJG(gkl(j, cj)) * xi * cavsig2_ss(k, at, fg, ck) + &
             & -CONJG(gkl(k, ck)) * xi * cavsig2_ss(j, at, fg, cj)
        B(4) = Gamma * (xi ** 2) * cav2_ss(j, k, at, cj, ck) + &
             & -CONJG(gkl(j, cj)) * xi * cavsig2_ss(k, at, fe, ck) + &
             & -CONJG(gkl(k, ck)) * xi * cavsig2_ss(j, at, fe, cj)
        B(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, at, cj, ck) + &
        ...
        B(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, at, cj, ck)
        B(7) = -CONJG(gkl(j, cj)) * cavsig2_ss(k, at, ef, ck) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -CONJG(gkl(j, cj)) * cavsig2_ss(k, a, eg, ck) + &
             & -gkl(k, ck) * cavsig2_ss(j, at, ge, cj)
        B(2) = -CONJG(gkl(j, cj)) * cavsig2_ss(k, a, ee, ck) + &
             & -gkl(k, ck) * xi * cavsig2_ss(j, at, gf, cj)
        B(3) = -CONJG(gkl(j, cj)) * xi * cavsig2_ss(k, a, fg, ck) + &
             & -gkl(k, ck) * cavsig2_ss(j, at, ee, cj)
        B(4) = Gamma * (xi ** 2) * cav2_ss(j, k, ata, cj, ck) + &
             & -CONJG(gkl(j, cj)) * xi * cavsig2_ss(k, a, fe, ck) + &
             & -gkl(k, ck) * xi * cavsig2_ss(j, at, ef, cj)
        B(5) = i * xi * 0.5d0 * Omega * cav2_ss(j, k, ata, cj, ck) + &
             & CONJG(gkl(j, cj)) * xi * cavsig2_ss(k, a, gg, ck) + &
             & CONJG(gkl(j, cj)) * xi * cavsig2_ss(k, a, ee, ck) + &
             & -CONJG(gkl(j, cj)) * xi * cav1_ss(k, a, ck)
        B(6) = -i * xi * 0.5d0 * Omega * cav2_ss(j, k, ata, cj, ck) + &
             & gkl(k, ck) * xi * cavsig2_ss(j, at, gg, cj) + &
             & gkl(k, ck) * xi * cavsig2_ss(j, at, ee, cj) + &
             & -gkl(k, ck) * xi * cav1_ss(j, at, cj)
        B(7) = -CONJG(gkl(j, cj)) * cavsig2_ss(k, a, ef, ck)
        B(8) = - gkl(k, ck) * cavsig2_ss(j, at, fe, cj)
      ...
      DO l = -N, N
        DO k = -N, N
          DO j = -N, N
            ...
            ! Set the non-homogeneous vector
            B = 0.0d0
            B(1) = -CONJG(gkl(j, cj)) * cavsig3_ss(k, l, a, eg, ck, cl) + &
                 & -gkl(k, ck) * cavsig3_ss(j, l, ata, ge, cj, cl) + &
                 & -gkl(l, cl) * cavsig3_ss(j, k, ata, ge, cj, ck)
            B(2) = -CONJG(gkl(j, cj)) * cavsig3_ss(k, l, a, ee, ck, cl) + &
                 & -gkl(k, ck) * xi * cavsig3_ss(j, l, ata, gf, cj, cl) + &
                 & -gkl(l, cl) * xi * cavsig3_ss(j, k, ata, gf, cj, ck)
            B(3) = -CONJG(gkl(j, cj)) * xi * cavsig3_ss(k, l, a, fg, ck, cl) + &
                 & -gkl(k, ck) * cavsig3_ss(j, l, ata, ee, cj, cl) + &
                 & -gkl(l, cl) * cavsig3_ss(j, k, ata, ee, cj, ck)
            B(4) = Gamma * (xi ** 2) * cav3_ss(j, k, l, a, cj, ck, cl) + &
                 & -CONJG(gkl(j, cj)) * xi * cavsig3_ss(k, l, a, fe, ck, cl) + &
                 & -gkl(k, ck) * xi * cavsig3_ss(j, l, ata, ef, cj, cl) + &
                 & -gkl(l, cl) * xi * cavsig3_ss(j, k, ata, ef, cj, ck)
            B(5) = i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, a, cj, ck, cl) + &
            ...
            B(6) = -i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, a, cj, ck, cl) + &
            ...
            B(7) = -CONJG(gkl(j, cj)) * cavsig3_ss(k, l, a, ef, ck, cl)
            B(8) = -gkl(k, ck) * cavsig3_ss(j, l, ata, fe, cj, cl) + &
            ...
            ! Set the non-homogeneous vector
            B = 0.0d0
            B(1) = -CONJG(gkl(j, cj)) * cavsig3_ss(k, l, ata, eg, ck, cl) + &
                 & -CONJG(gkl(k, ck)) * cavsig3_ss(j, l, ata, eg, cj, cl) + &
                 & -gkl(l, cl) * cavsig3_ss(j, k, at, ge, cj, ck)
            B(2) = -CONJG(gkl(j, cj)) * cavsig3_ss(k, l, ata, ee, ck, cl) + &
                 & -CONJG(gkl(k, ck)) * cavsig3_ss(j, l, ata, ee, cj, cl) + &
                 & -gkl(l, cl) * xi * cavsig3_ss(j, k, at, gf, cj, ck)
            B(3) = -CONJG(gkl(j, cj)) * xi * cavsig3_ss(k, l, ata, fg, ck, cl) + &
                 & -CONJG(gkl(k, ck)) * xi * cavsig3_ss(j, l, ata, fg, cj, cl) + &
                 & -gkl(l, cl) * cavsig3_ss(j, k, at, ee, cj, ck)
            B(4) = Gamma * (xi ** 2) * cav3_ss(j, k, l, at, cj, ck, cl) + &
                 & -CONJG(gkl(j, cj)) * xi * cavsig3_ss(k, l, ata, fe, ck, cl) + &
                 & -CONJG(gkl(k, ck)) * xi * cavsig3_ss(j, l, ata, fe, cj, cl) + &
                 & -gkl(l, cl) * xi * cavsig3_ss(j, k, at, ef, cj, ck)
            B(5) = i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, at, cj, ck, cl) + &
            ...
            B(6) = -i * xi * 0.5d0 * Omega * cav3_ss(j, k, l, at, cj, ck, cl) + &
                 & gkl(l, cl) * xi * cavsig3_ss(j, k, at, gg, cj, ck) + &
                 & gkl(l, cl) * xi * cavsig3_ss(j, k, at, ee, cj, ck) + &
                 & -gkl(l, cl) * xi * cav2_ss(j, k, at, cj, ck)
            B(7) = -CONJG(gkl(j, cj)) * cavsig3_ss(k, l, ata, ef, ck, cl) + &
                 & -CONJG(gkl(k, ck)) * cavsig3_ss(j, l, ata, ef, ck, cl)
            B(8) = -gkl(l, cl) * cavsig3_ss(j, k, at, fe, cj, ck)
...
DO t = 0, tau_steps
  ...
  DO j = -N, N
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -gkl(j, cj) * sigma(ge)
    B(2) = -gkl(j, cj) * xi * sigma(gf)
    B(3) = -gkl(j, cj) * sigma(ee)
    ...
    B(7) = 0.0d0
    B(8) = -gkl(j, cj) * sigma(fe)
    ! Calculate k1
    k1_cavsig2(j, a, :) = dt * (MATMUL(Mat, cavsig2(j, a, :)) + B)

    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -gkl(j, cj) * (sigma(ge) + 0.5d0 * k1_sigma(ge))
    B(2) = -gkl(j, cj) * xi * (sigma(gf) + 0.5d0 * k1_sigma(gf))
    B(3) = -gkl(j, cj) * (sigma(ee) + 0.5d0 * k1_sigma(ee))
    ...
    B(6) = -i * xi * 0.5d0 * Omega * (cav1(j, a) + 0.5d0 * k1_cav1(j, a)) + &
         ...
         & -gkl(j, cj) * xi * photona_ss
    B(7) = 0.0d0
    B(8) = -gkl(j, cj) * (sigma(fe) + 0.5d0 * k1_sigma(fe))
    ! Calculate k2
    k2_cavsig2(j, a, :) = dt * (MATMUL(Mat, (cavsig2(j, a, :) + 0.5d0 * k1_cavsig2(j, a, :))) + B)

    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -gkl(j, cj) * (sigma(ge) + 0.5d0 * k2_sigma(ge))
    B(2) = -gkl(j, cj) * xi * (sigma(gf) + 0.5d0 * k2_sigma(gf))
    B(3) = -gkl(j, cj) * (sigma(ee) + 0.5d0 * k2_sigma(ee))
    ...
    B(6) = -i * xi * 0.5d0 * Omega * (cav1(j, a) + 0.5d0 * k2_cav1(j, a)) + &
         ...
         & -gkl(j, cj) * xi * photona_ss
    B(7) = 0.0d0
    B(8) = -gkl(j, cj) * (sigma(fe) + 0.5d0 * k2_sigma(fe))
    ! Calculate k3
    k3_cavsig2(j, a, :) = dt * (MATMUL(Mat, (cavsig2(j, a, :) + 0.5d0 * k2_cavsig2(j, a, :))) + B)

    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -gkl(j, cj) * (sigma(ge) + k3_sigma(ge))
    B(2) = -gkl(j, cj) * xi * (sigma(gf) + k3_sigma(gf))
    B(3) = -gkl(j, cj) * (sigma(ee) + k3_sigma(ee))
    ...
    B(6) = -i * xi * 0.5d0 * Omega * (cav1(j, a) + k3_cav1(j, a)) + &
         ...
         & -gkl(j, cj) * xi * photona_ss
    B(7) = 0.0d0
    B(8) = -gkl(j, cj) * (sigma(fe) + k3_sigma(fe))
    ! Calculate k4
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -CONJG(gkl(j, cj)) * sigma(eg)
    B(2) = -CONJG(gkl(j, cj)) * sigma(ee)
    B(3) = -CONJG(gkl(j, cj)) * xi * sigma(fg)
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -CONJG(gkl(j, cj)) * (sigma(eg) + 0.5d0 * k1_sigma(eg))
    B(2) = -CONJG(gkl(j, cj)) * (sigma(ee) + 0.5d0 * k1_sigma(ee))
    B(3) = -CONJG(gkl(j, cj)) * xi * (sigma(fg) + 0.5d0 * k1_sigma(fg))
    ...
    B(7) = -CONJG(gkl(j, cj)) * (sigma(ef) + 0.5d0 * k1_sigma(ef))
    B(8) = 0.0d0
    ! Calculate k2
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -CONJG(gkl(j, cj)) * (sigma(eg) + 0.5d0 * k2_sigma(eg))
    B(2) = -CONJG(gkl(j, cj)) * (sigma(ee) + 0.5d0 * k2_sigma(ee))
    B(3) = -CONJG(gkl(j, cj)) * xi * (sigma(fg) + 0.5d0 * k2_sigma(fg))
    ...
    B(7) = -CONJG(gkl(j, cj)) * (sigma(ef) + 0.5d0 * k2_sigma(ef))
    B(8) = 0.0d0
    ! Calculate k3
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -CONJG(gkl(j, cj)) * (sigma(eg) + k3_sigma(eg))
    B(2) = -CONJG(gkl(j, cj)) * (sigma(ee) + k3_sigma(ee))
    B(3) = -CONJG(gkl(j, cj)) * xi * (sigma(fg) + k3_sigma(fg))
    ...
    B(7) = -CONJG(gkl(j, cj)) * (sigma(ef) + k3_sigma(ef))
    B(8) = 0.0d0
    ! Calculate k4

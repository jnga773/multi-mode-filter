...
WRITE(*, '(A7,I2,A5,I2,A11,ES18.11E2,A3,ES18.11E2,A1)') "  < f_", j, "  f_", k, " sm >_ss = ", &
  & REAL(f2sig_ss(j, k, ff, sm)), " + ", AIMAG(f2sig_ss(j, k, ff, sm)), "i"
WRITE(*, '(A7,I2,A5,I2,A11,ES18.11E2,A3,ES18.11E2,A1)') " < ft_", j, " f_", k, " sz >_ss = ", &
  & REAL(f2sig_ss(j, k, ftf, sz)), " + ", AIMAG(f2sig_ss(j, k, ftf, sz)), "i"
WRITE(*, '(A7,I2,A5,I2,A11,ES18.11E2,A3,ES18.11E2,A1)') " < ft_", j, " ft_", k, " sp >_ss = ", &

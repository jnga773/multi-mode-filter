...
#-------------------#
# Plot titles
title_auto = r'Auto-Correlation $\left( \Omega = {} \gamma, N = {} \right)$'
...
ax[0].set_title(title_auto.format(round(Omega, 3), N), fontsize=15)
...
ax[1].set_title(title_cross.format(round(w0a, 3), kappa, round(dw, 3), round(w0b, 3)), fontsize=15)

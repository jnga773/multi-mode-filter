...
DO t = 0, tau_steps
  ...
  DO j = -N, N
    ...
    B_vec = 0.0d0
    B_vec(1) = 0.0d0
    B_vec(2) = -0.5d0 * gkl(j, b) * (sigma(sz) + photonb_ss)
    ...
    B_vec = 0.0d0
    B_vec(1) = 0.0d0
    B_vec(2) = -0.5d0 * gkl(j, b) * ((sigma(sz) + 0.5d0 * k1_sigma(sz)) + photonb_ss)
    ...
    B_vec = 0.0d0
    B_vec(1) = 0.0d0
    B_vec(2) = -0.5d0 * gkl(j, b) * ((sigma(sz) + 0.5d0 * k2_sigma(sz)) + photonb_ss)
    ...
    B_vec = 0.0d0
    B_vec(1) = 0.0d0
    B_vec(2) = -0.5d0 * gkl(j, b) * ((sigma(sz) + k3_sigma(sz)) + photonb_ss)
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -0.5d0 * CONJG(gkl(j, b)) * (sigma(sz) + photonb_ss)
    B_vec(2) = 0.0d0
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -0.5d0 * CONJG(gkl(j, b)) * ((sigma(sz) + 0.5d0 * k1_sigma(sz)) + photonb_ss)
    B_vec(2) = 0.0d0
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -0.5d0 * CONJG(gkl(j, b)) * ((sigma(sz) + 0.5d0 * k2_sigma(sz)) + photonb_ss)
    B_vec(2) = 0.0d0
    ...
    ! Set the non-homogeneous vector
    B_vec = 0.0d0
    B_vec(1) = -0.5d0 * CONJG(gkl(j, b)) * ((sigma(sz) + k3_sigma(sz)) + photonb_ss)
    B_vec(2) = 0.0d0

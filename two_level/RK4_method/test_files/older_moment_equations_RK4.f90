...
COMPLEX(KIND=8) :: corr, moment_out
...
CHARACTER(LEN=27), PARAMETER :: filename_state = "./data_files/old_states.txt"
...
! Filename for cavity moments
CHARACTER(LEN=30), PARAMETER :: filename_cavity = "./data_files/old_operators.txt"
...
WRITE(*, '(A12,ES18.11E2,A3,ES18.11E2,A2)') "< sm >_ss = ", REAL(bloch(sm)), " + ", IMAG(bloch(sm)), "i"
WRITE(*, '(A12,ES18.11E2,A3,ES18.11E2,A2)') "< sp >_ss = ", REAL(bloch(sp)), " + ", IMAG(bloch(sp)), "i"
WRITE(*, '(A12,ES18.11E2,A3,ES18.11E2,A2)') "< sz >_ss = ", REAL(bloch(sz)), " + ", IMAG(bloch(sz)), "i"
WRITE(*, *) "=============================================="

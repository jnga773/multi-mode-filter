...
DO t = 0, t_steps
  ...
  DO j = -N, N
    ...
    B = 0.0d0
    B(1) = 0.0d0
    B(2) = -0.5d0 * gkl(j) * (sigma(sz) + 1.0d0)
    B(3) = -gamma * cav1(j, a) + &
         & gkl(j) * sigma(sm)
    ! Calculate k1
    ...
    B = 0.0d0
    B(1) = 0.0d0
    B(2) = -0.5d0 * gkl(j) * ((sigma(sz) + 0.5d0 * k1_sigma(sz)) + 1.0d0)
    ...
    B = 0.0d0
    B(1) = 0.0d0
    B(2) = -0.5d0 * gkl(j) * ((sigma(sz) + 0.5d0 * k2_sigma(sz)) + 1.0d0)
    ...
    B = 0.0d0
    B(1) = 0.0d0
    B(2) = -0.5d0 * gkl(j) * ((sigma(sz) + k3_sigma(sz)) + 1.0d0)
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -0.5d0 * CONJG(gkl(j)) * (sigma(sz) + 1.0d0)
    B(2) = 0.0d0
    B(3) = -gamma * cav1(j, at) + &
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -0.5d0 * CONJG(gkl(j)) * ((sigma(sz) + 0.5d0 * k1_sigma(sz)) + 1.0d0)
    B(2) = 0.0d0
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -0.5d0 * CONJG(gkl(j)) * ((sigma(sz) + 0.5d0 * k2_sigma(sz)) + 1.0d0)
    B(2) = 0.0d0
    ...
    ! Set the non-homogeneous vector
    B = 0.0d0
    B(1) = -0.5d0 * CONJG(gkl(j)) * ((sigma(sz) + k3_sigma(sz)) + 1.0d0)
    B(2) = 0.0d0
  ...
  DO j = -N, N
    DO k = -N, N
      ...
      B = 0.0d0
      B(1) = 0.0d0
      B(2) = -0.5d0 * gkl(j) * (cavsig2(k, a, sz) + 0.5d0 * k1_cavsig2(k, a, sz)) + &
      ...
      B(3) = -gamma * (cav2(j, k, a) + 0.5d0 * k1_cav2(j, k, a)) + &
      ...
      B = 0.0d0
      B(1) = 0.0d0
      B(2) = -0.5d0 * gkl(j) * (cavsig2(k, a, sz) + 0.5d0 * k2_cavsig2(k, a, sz)) + &
      ...
      B(3) = -gamma * (cav2(j, k, a) + 0.5d0 * k2_cav2(j, k, a)) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig2(k, at, sz) + 0.5d0 * k1_cavsig2(k, at, sz)) + &
      ...
      B(2) = 0.0d0
      B(3) = -gamma * (cav2(j, k, at) + 0.5d0 * k1_cav2(j, k, at)) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig2(k, at, sz) + 0.5d0 * k2_cavsig2(k, at, sz)) + &
      ...
      B(2) = 0.0d0
      B(3) = -gamma * (cav2(j, k, at) + 0.5d0 * k2_cav2(j, k, at)) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig2(k, at, sz) + k3_cavsig2(k, at, sz)) + &
      ...
      B(2) = 0.0d0
      B(3) = -gamma * (cav2(j, k, at) + k3_cav2(j, k, at)) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * cavsig2(k, a, sz) + &
           & -0.5d0 * CONJG(gkl(j)) * cav1(k, a)
      B(2) = -0.5d0 * gkl(k) * cavsig2(j, at, sz) + &
           & -0.5d0 * gkl(k) * cav1(j, at)
      B(3) = -gamma * cav2(j, k, ata) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig2(k, a, sz) + 0.5d0 * k1_cavsig2(k, a, sz)) + &
           & -0.5d0 * CONJG(gkl(j)) * (cav1(k, a) + 0.5d0 * k1_cav1(k, a))
      B(2) = -0.5d0 * gkl(k) * (cavsig2(j, at, sz) + 0.5d0 * k1_cavsig2(j, at, sz)) + &
           & -0.5d0 * gkl(k) * (cav1(j, at) + 0.5d0 * k1_cav1(j, at))
      B(3) = -gamma * (cav2(j, k, ata) + 0.5d0 * k1_cav2(j, k, ata)) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig2(k, a, sz) + 0.5d0 * k2_cavsig2(k, a, sz)) + &
           & -0.5d0 * CONJG(gkl(j)) * (cav1(k, a) + 0.5d0 * k2_cav1(k, a))
      B(2) = -0.5d0 * gkl(k) * (cavsig2(j, at, sz) + 0.5d0 * k2_cavsig2(j, at, sz)) + &
           & -0.5d0 * gkl(k) * (cav1(j, at) + 0.5d0 * k2_cav1(j, at))
      B(3) = -gamma * (cav2(j, k, ata) + 0.5d0 * k2_cav2(j, k, ata)) + &
      ...
      ! Set the non-homogeneous vector
      B = 0.0d0
      B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig2(k, a, sz) + k3_cavsig2(k, a, sz)) + &
           & -0.5d0 * CONJG(gkl(j)) * (cav1(k, a) + k3_cav1(k, a))
      B(2) = -0.5d0 * gkl(k) * (cavsig2(j, at, sz) + k3_cavsig2(j, at, sz)) + &
           & -0.5d0 * gkl(k) * (cav1(j, at) + k3_cav1(j, at))
      B(3) = -gamma * (cav2(j, k, ata) + k3_cav2(j, k, ata)) + &
  ...
  DO l = -N, N
    DO k = -N, N
      DO j = -N, N
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig3(k, l, a, sz) + 0.5d0 * k1_cavsig3(k, l, a, sz)) + &
             & -0.5d0 * CONJG(gkl(j)) * (cav2(k, l, a) + 0.5d0 * k1_cav2(k, l, a))
        B(2) = -0.5d0 * gkl(k) * (cavsig3(j, l, ata, sz) + 0.5d0 * k1_cavsig3(j, l, ata, sz)) + &
        ...
        B(3) = -gamma * (cav3(j, k, l, a) + 0.5d0 * k1_cav3(j, k, l, a)) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig3(k, l, a, sz) + 0.5d0 * k2_cavsig3(k, l, a, sz)) + &
             & -0.5d0 * CONJG(gkl(j)) * (cav2(k, l, a) + 0.5d0 * k2_cav2(k, l, a))
        B(2) = -0.5d0 * gkl(k) * (cavsig3(j, l, ata, sz) + 0.5d0 * k2_cavsig3(j, l, ata, sz)) + &
        ...
        B(3) = -gamma * (cav3(j, k, l, a) + 0.5d0 * k2_cav3(j, k, l, a)) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig3(k, l, a, sz) + k3_cavsig3(k, l, a, sz)) + &
             & -0.5d0 * CONJG(gkl(j)) * (cav2(k, l, a) + k3_cav2(k, l, a))
        B(2) = -0.5d0 * gkl(k) * (cavsig3(j, l, ata, sz) + k3_cavsig3(j, l, ata, sz)) + &
        ...
        B(3) = -gamma * (cav3(j, k, l, a) + k3_cav3(j, k, l, a)) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig3(k, l, ata, sz) + 0.5d0 * k1_cavsig3(k, l, ata, sz)) + &
        ...
        B(2) = -0.5d0 * gkl(l) * (cavsig3(j, k, at, sz) + 0.5d0 * k1_cavsig3(j, k, at, sz)) + &
             & -0.5d0 * gkl(l) * (cav2(j, k, at) + 0.5d0 * k1_cav2(j, k, at))
        B(3) = -gamma * (cav3(j, k, l, at) + 0.5d0 * k1_cav3(j, k, l, at)) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig3(k, l, ata, sz) + 0.5d0 * k2_cavsig3(k, l, ata, sz)) + &
        ...
        B(2) = -0.5d0 * gkl(l) * (cavsig3(j, k, at, sz) + 0.5d0 * k2_cavsig3(j, k, at, sz)) + &
             & -0.5d0 * gkl(l) * (cav2(j, k, at) + 0.5d0 * k2_cav2(j, k, at))
        B(3) = -gamma * (cav3(j, k, l, at) + 0.5d0 * k2_cav3(j, k, l, at)) + &
        ...
        ! Set the non-homogeneous vector
        B = 0.0d0
        B(1) = -0.5d0 * CONJG(gkl(j)) * (cavsig3(k, l, ata, sz) + k3_cavsig3(k, l, ata, sz)) + &
        ...
        B(2) = -0.5d0 * gkl(l) * (cavsig3(j, k, at, sz) + k3_cavsig3(j, k, at, sz)) + &
             & -0.5d0 * gkl(l) * (cav2(j, k, at) + k3_cav2(j, k, at))
        B(3) = -gamma * (cav3(j, k, l, at) + k3_cav3(j, k, l, at)) + &
